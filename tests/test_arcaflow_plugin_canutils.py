...
class HelloWorldTest(unittest.TestCase):
    ...
    def test_functional(self):
        input = canutils_plugin.InputParams(name="Example Joe")

        output_id, output_data = canutils_plugin.hello_world(
        ...
        self.assertEqual(
            output_data,
            canutils_plugin.SuccessOutput("Hello, Example Joe!"),
        )
